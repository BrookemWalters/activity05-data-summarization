...
**Response**:
There will be less observations at the end, $22k, and $110k and more observations around the median of $36k
...
**Response**: we can see that interdisciplinary studies has only 1 result and therefore no standard deviation
...
**Response**: it is much easier to read in the table than on this abomination of a boxplot graph
